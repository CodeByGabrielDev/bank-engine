...
public abstract class Pessoa {
	...
	public Pessoa(Enderecamento cep, int numeroEndereco, int compleEndereco, String telefone, Date clienteDesde,
	...
	public int getCompleEndereco() {
		return compleEndereco;
	}

	public void setCompleEndereco(int compleEndereco) {
		if (this.situacao == SituacaoCliente.ativo) {
			this.compleEndereco = compleEndereco;
		}
		throw new IllegalArgumentException("Usuario nao ativo");
