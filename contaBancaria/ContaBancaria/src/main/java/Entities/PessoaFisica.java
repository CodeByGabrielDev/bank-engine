...
public class PessoaFisica extends Pessoa {
	...
	public PessoaFisica(Enderecamento cep, int numeroEndereco, int compleEndereco, String telefone, Date clienteDesde,
			SituacaoCliente situacao, String cpf, String nomeDeRegistro, String nomeSocial, Date dataDeNascimento,
			Sexo sexo, double rendaMensal) {
