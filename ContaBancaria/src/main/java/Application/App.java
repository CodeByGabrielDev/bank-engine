...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println(cbc.findAllContaBancaria());
		System.out.println(cbc.findAllContaCorrente());
		System.out.println(cbc.findAllContaEspecial());
		System.out.println(cbc.findAllContaPoupanca());
		System.out.println(cbc.findAllContaSalario());
		System.out.println(pessoa.findAllJuridicas());
		System.out.println(pessoa.findAllPessoa());
		System.out.println(pessoa.findAllPessoaFisicas());
